...
#[derive(Debug)]
pub struct FunctionTypeStore {
    types: BTreeMap<FunctionId, FunctionType>,
}

impl FunctionTypeStore {
    pub fn new() -> FunctionTypeStore {
        FunctionTypeStore {
            types: BTreeMap::new(),
        }
    }

    pub fn add_function_type(&mut self, id: FunctionId, ty: FunctionType) {
        self.types.insert(id, ty);
    }

    pub fn get_function_type(&self, id: &FunctionId) -> Option<FunctionType> {
